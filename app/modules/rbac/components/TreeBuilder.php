 ...
 * 2.1 Call widget from model like static::findOne(1)->menuWidget()
 * 2.2 Call checkbox widget like static::findOne(1)->checkboxWidget('node', $selectedItemIds)
 *
 */
class TreeBuilder extends SimpleTreeBehavior
{
    ...
    {
        $uniqueKey = $uniqueKey ? $uniqueKey : static::$uniqueKey++;
