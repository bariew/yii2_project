...
class Log extends ActiveRecord
{
     ...
     */
    public static function findForModel(ActiveRecord $model)
    {
     ...
     * @return array
     */
    public static function modelUrl(ActiveRecord $model)
    {
        return ['/log/item/index', "ItemSearch[model_name]" => get_class($model), "ItemSearch[model_id]" => $model->primaryKey];
    }
