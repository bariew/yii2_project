<?php //[STAMP] 66359854a6cf53b5dcec54a8be505fd3
...
class FunctionalTester extends \Codeception\Actor
{
     ...
     * ``` php
     * <?php
     * $user_id = $I->haveRecord('app\modules\common\models\User', array('name' => 'Davert'));
     * ?>
     * ```
     *
     * @param $model
     ...
     *
     * ``` php
     * $I->seeRecord('app\modules\common\models\User', array('name' => 'davert'));
     * ```
     *
     * @param $model
     * @param array $attributes
     ...
     *
     * ``` php
     * $I->dontSeeRecord('app\modules\common\models\User', array('name' => 'davert'));
     * ```
     *
     * @param $model
     * @param array $attributes
     ...
     *
     * ``` php
     * $category = $I->grabRecord('app\modules\common\models\User', array('name' => 'davert'));
     * ```
     *
     * @param $model
     * @param array $attributes
